...
(function (undefined) {
  ...
  {
  	var x=" "+word.toLowerCase().replace('.','').replace('?','').replace(',','')+" ";
  	x=x.replace(" busch gardens "," bushwick ").replace(" busch light "," bushwick ").replace(" in bushwick "," ");
  	x=x.replace(" bushkill "," bushwick ");
  	x=x.replace(" the "," ").replace(" is "," ").replace(" are "," ");
  	x=x.replace(" wikipedia entry "," wikipedia ");
  	x=x.replace(" of "," ");
  	x=x.replace(" and "," ");
  	x=x.replace(" an "," ");
  	x=x.replace(" me "," ");
  	x=x.replace(" some "," ");
  	x=x.replace(" please "," ");
  	x=x.replace(" can i see "," show me ");
  	x=x.replace(" list "," show me ");
  	x=x.replace(" check out "," ");
  	x=x.replace(" checkout "," ");
  	x=x.replace(" about "," ");
  	x=x.replace(" tell me "," show me ");
  	x=x.replace(" show me "," ");
  	x=x.replace(" what "," ");
  	x=x.replace(" whats "," ");
  	x=x.replace(" which "," ");
  	...
  	x=x.replace(" any "," ");
  	x=x.replace(" there "," ");
  	x=x.replace(" how should "," ");
  	x=x.replace(" from bushwick "," ");
  	x=x.replace(" a "," ");
  	x=x.replace(" how should "," ");
  	x=x.replace(" how "," ");
  	x=x.replace(" in area "," ");
  	...
  	x=x.replace(" it "," ");
  	x=x.replace(" isit "," ");
  	x=x.replace(" jfk airport "," jfk ");
  	x=x.replace(" john f kennedy airport "," jfk ");
  	x=x.replace(" john f kennedy "," jfk ");
  	x=x.replace(" lga airport "," lga ");
        ...
        for (var i = 0; i<results.length; i++) {
          ...
          for (var j = 0, l = commandsList.length; j < l; j++) {
            ...
            if (result) {
              ...
              if (debugState) {
                root.console.log('command matched: %c '+commandsList[j].originalPhrase+' => '+commandsList[j].transformedPhrase, debugStyle);
